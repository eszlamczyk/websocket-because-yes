...
'''
    ...
    @classmethod
    def WebSocket_server(client_socket: socket.socket, method, http_version, headers_map, buffer_size=1024*1024):
        ...
        def handle_ws_handshake_request(client_socket: socket.socket, headers_map: dict[str]):
        ...
        if is_valid_ws_handshake_request(method, http_version, headers_map):
            ...
            return WebSocket(client_socket, buffer_size, True)
        else:
